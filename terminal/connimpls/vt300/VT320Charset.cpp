...
uint32_t VT320_RemapL(uint32_t uc, int cs)
{
    ...
    case CS_PORTUGUESE:
        ...
        case 0x23: return L'#';
        case 0x40: return L'@';
        case 0x5b: return L'Ã';
        case 0x5c: return L'Ç';
        case 0x5d: return L'Õ';
        case 0x5e: return L'^';
        case 0x5f: return L'_';
        case 0x60: return L'`';
        case 0x7b: return L'ã';
        case 0x7c: return L'ç';
        case 0x7d: return L'õ';
        case 0x7e: return L'~';
        }
        break;
...
{
    if (uc < 0x80) return VT320_RemapL(uc, cs);
    else if (uc < 0x100) return VT320_RemapR(uc, extended_cs);
    else return uc;
}
