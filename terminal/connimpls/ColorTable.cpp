...
static const int kDefaultColorTbl[256] = {
    0xc83030, 0x20ca8b, 0x3b8eea, 0x505050, 0xdfdfdf, 0xbc40bc, 0x10eaea, 0xeaea10,
    0xd83030, 0x20da8b, 0x3b8efa, 0x606060, 0xefefef, 0xdc40dc, 0x10fafa, 0xfafa10,
...
{
    if (color_id < 256) {
        mTbl[color_id] = Color((kDefaultColorTbl[color_id] >> 16) & 0xff,
                               (kDefaultColorTbl[color_id] >> 8 ) & 0xff,
                               (kDefaultColorTbl[color_id] & 0xff));
    } else {
        switch (color_id) {
        case kColorId_Texts: mTbl[color_id] = Color(0xea, 0xea, 0xea); break;
        case kColorId_Paper: mTbl[color_id] = Color(0x20, 0x20, 0x20); break;
        }
    }
}
